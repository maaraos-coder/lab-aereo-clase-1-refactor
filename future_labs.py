        ...
        "labs": [
            {
                ...
                "stages": [
                    ("Introducción al problema",
                     ...
                     "La etapa presenta el problema general, la ruta completa del laboratorio y la forma de trabajo.",
                     "Reconoce las fuentes principales y revisa la ruta antes de comenzar."),
                    ...
                    ("Fundamentos del ruido de impacto",
                     ...
                     "La etapa introduce la transmisión vibroacústica del edificio y los mecanismos físicos asociados a fuentes de impacto.",
                     "Observa la fuente, sigue la energía y relaciona el impacto con la respuesta de la estructura."),
                    ...
                    ("Transmisión del ruido de impacto",
                     ...
                     "La etapa relaciona excitación, impedancia, movilidad, resonancia, ondas de flexión y radiación acústica.",
                     "Explora los interactivos y conecta fuerza, respuesta estructural, propagación y radiación."),
                    ...
                    ("Evaluación del aislamiento a ruido de impacto",
                     ...
                     "La etapa desarrolla el diagnóstico físico y la interpretación de evidencia para evaluar la transmisión estructural.",
                     "Analiza el problema, formula hipótesis y selecciona evidencia para comprobarlas."),
                    ...
                    ("Soluciones constructivas para ruido de impacto",
                     ...
                     "La etapa conecta la fuerza de contacto, la respuesta del piso y los mecanismos que posteriormente permiten diseñar soluciones constructivas.",
                     "Relaciona el tipo de impacto, la respuesta estructural y las variables que condicionan una solución."),
                    ...
                    ("Ruido generado por instalaciones",
                     ...
                     "La etapa utiliza la predicción del nivel de impacto de la losa base como puente para interpretar excitación, vibración y radiación en sistemas constructivos.",
                     "Calcula por bandas y reconoce cómo una fuente mecánica termina generando ruido en un recinto."),
                    ...
                    ("Transmisión estructural de vibraciones",
                     ...
                     "La etapa estudia desacoplamiento, masa, rigidez, resonancia y transmisibilidad como fundamentos del control vibratorio.",
                     "Manipula masa y rigidez, mueve la resonancia y analiza cuándo aparece aislamiento efectivo."),
                    ...
                    ("Diagnóstico acústico de instalaciones",
                     ...
                     "La etapa integra predicción, sensibilidad, constructibilidad y lectura de caminos de transmisión antes de seleccionar medidas de control.",
                     "Compara alternativas, identifica caminos dominantes y justifica un diagnóstico técnico."),
                    ...
                    ("Medidas de control de ruido y vibraciones",
                     ...
                     "La etapa aplica medidas de control a equipos, apoyos, tuberías, ductos, cerramientos y receptores según el mecanismo dominante.",
                     "Selecciona y combina medidas de control coherentes con cada camino de transmisión."),

                    ("Preguntas de comprensión",
                     "Integra los conceptos fundamentales del laboratorio mediante preguntas de análisis, interpretación y aplicación.",
                     "La etapa comprueba la comprensión de transmisión, impacto, vibraciones, instalaciones y medidas de control.",
                     "Responde las preguntas, comprueba tus resultados y revisa la retroalimentación."),

                    ("Desafío integrador",
                     "Resuelve un caso completo de ruido de impacto e instalaciones combinando cálculos, diagnóstico, comparación de alternativas y decisiones de diseño.",
                     "La etapa integra los modelos, herramientas y criterios del laboratorio en un problema profesional con dos fuentes simultáneas.",
                     "Calcula, experimenta, compara alternativas, diagnostica y construye una solución técnica integral."),
                ],
            },
            {
                "number": 2,
